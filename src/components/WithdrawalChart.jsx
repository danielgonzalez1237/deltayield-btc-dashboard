    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        <div className="bg-[#0d0d17] border border-[#1a1a2e] rounded-2xl px-6 py-5">
          <div className="text-[11px] text-[#555570] uppercase tracking-wider mb-2 font-semibold">Compound (No Withdrawal)</div>
        ...
        {FREQS.map(freq => (
          <div key={freq} className="bg-[#0d0d17] border border-[#1a1a2e] rounded-2xl px-6 py-5">
            <div className="text-[11px] text-[#555570] uppercase tracking-wider mb-2 font-semibold">{FREQ_LABELS[freq]}</div>
            ...
            <div className="text-[11px] text-[#555570] mt-1">Yield: {results[freq].effectiveYield}%</div>
          </div>
        ))}
      </div>
      ...
      <div className="bg-[#0d0d17] border border-[#1a1a2e] rounded-3xl p-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-[11px] text-[#555570] mt-1">Compound vs periodic profit withdrawals</p>
          </div>
        ...
        <ResponsiveContainer width="100%" height={420}>
          <ComposedChart data={chartData} margin={{ top: 5, right: 10, left: isUsd ? 10 : -5, bottom: 0 }}>
            ...
            <Line type="monotone" dataKey="compound" name="Compound" stroke="#f7931a" strokeWidth={2.5} dot={false} />
            {FREQS.map(freq => (
